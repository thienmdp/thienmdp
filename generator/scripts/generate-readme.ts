...
import { convertReadmeMdToImage, generateReadmeMarkdownFile } from "../utils/readme.ts";

const lightModeImageFilepath = path.join(monorepoDirpath, "data/figma-exports/README (Light Mode).png");
const darkModeImageFilepath = path.join(monorepoDirpath, "data/figma-exports/README (Dark Mode).png");
...
const [lightModeImagePieces, darkModeImagePieces, lightModeReadmeMdImageFilepath, darkModeReadmeMdImageFilepath] =
  await Promise.all([
