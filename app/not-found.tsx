    ...
    <div className='flex h-screen w-full flex-col items-center justify-center'>
      ...
      <div className='flex flex-col items-center justify-center'>
        ...
        <p className='mt-4 text-gray-500 md:text-lg xl:text-xl'>
          Trang bạn đang tìm kiếm không tồn tại. Có thể nó đã bị di chuyển hoặc xóa.
        </p>
        <Link
          href='/'
          className='mt-6 rounded-md bg-red-500 px-6 py-3 font-semibold text-white hover:from-pink-500 '
        >
          Quay về trang chủ
        </Link>
      </div>
